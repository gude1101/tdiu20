...
public:
	...
	simulation_params() : iterations{200000}, prints{10}, delta_t{0.01}, bat_voltage{24} { }

	simulation_params(int argc, char* argv[]) : simulation_params() {
		if (argc < 5) {
...
void example_1(simulation_params params) {
	...
	net.push_back(new Battery("Bat", 24, N, P));
...
void example_2(simulation_params p) {
	...
	net.push_back(new Battery("U", 24, N, P));
